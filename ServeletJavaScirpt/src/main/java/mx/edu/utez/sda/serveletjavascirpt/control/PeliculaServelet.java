package mx.edu.utez.sda.serveletjavascirpt.control;
...
@WebServlet(name = "PeliculaServelet", value = "/PeliculaServelet")
public class PeliculaServelet  extends HttpServlet {
    @Override
